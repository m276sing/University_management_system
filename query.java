                            ...
                            if (course.length() > 0) {
                                ...
                                if (query1.length() > 0) {
                                    ...
                                    if (w = haveNetworkConnection()) {
                                        new Reg().execute("");
                                        Toast.makeText(getApplication(), "Thank You For Your Interest", Toast.LENGTH_LONG).show();
    ...
    class Reg extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                HttpPost httpPost = new HttpPost("http://itronixsolutions.com/Android/one1.php");
