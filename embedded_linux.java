...
public class embedded_linux extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_embedded_linux);


        search1 = (Spinner) findViewById (R.id.search1);
        btn1=(Button)findViewById(R.id.btn1);
        String ar[]={"Select course","Raspberry Pi","Friendly ARM Mini2440"};
                ...
                btn1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (w = haveNetworkConnection()) {
                            if (s.equalsIgnoreCase("Raspberry pi")) {
                                fragment = new bigdataf();
                                b.putString("url","https://www.itronixsolutions.com/raspberry-pi-training-mohali/");
                                fragment.setArguments(b);
                                Toast.makeText(getApplication(), "Raspberry pi", Toast.LENGTH_LONG).show();
                            } else if (s.equalsIgnoreCase("Friendly ARM Mini2440")) {
                                fragment = new bigdataf();
                                b.putString("url","https://www.itronixsolutions.com/friendly-arm-mini2440-training-mohali/");
                                fragment.setArguments(b);
                                Toast.makeText(getApplication(), "Friendly ARM Mini2440", Toast.LENGTH_LONG).show();
                            }
                            else {
                        ...
                        {
                            new AlertDialog.Builder(embedded_linux.this)
